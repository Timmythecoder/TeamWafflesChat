var firebaseConfig = {
  ...
  function getData() {  firebase.database().ref("rooms").limitToLast(50).on('value', function(snapshot) { document.getElementById("output").innerHTML = ""; snapshot.forEach(function(childSnapshot) { childKey  = childSnapshot.key;
         Room_names = childKey;
