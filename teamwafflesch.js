var firebaseConfig = {
  ...
  function getData() {
      ...
      firebase.database().ref("rooms").limitToLast(50).on('child_added', function(childSnapshot) {
          childKey = childSnapshot.key;
          Room_names = childKey;
          console.log("Room Name - " + Room_names);
          // Prepend to show newest on top if desired, or append.
          // Since limitToLast gives oldest to newest, append is standard order.
