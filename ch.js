...
onChildAdded(query(ref(database, 'config/broadcast'), limitToLast(1)), (snap) => {
...
function markUnread() {
    ...
    if (otherUID) {
        // This sets the 'unread' flag for the other user in their own user data.
        // The path is users/{other_user_id}/private_chats/{my_id}
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  function initPresence() {
    ...
    const onlineUsersRef = ref(database, `rooms/${room_name}/onlineUsers`);
